"""Safe Activity Protocol context card helpers for the Email Assistant."""
...
def _build_manager_context(manager: dict[str, str] | None) -> dict[str, str]:
    ...
    return {
        ...
        "forwardedEmailRule": "Only email forwarded by this Manager is processed.",
    }
...
def _display_label(value: str) -> str:
    labels = {
        ...
        "mail": "Mail",
        "forwardedEmailRule": "Forwarded email rule",
    }
