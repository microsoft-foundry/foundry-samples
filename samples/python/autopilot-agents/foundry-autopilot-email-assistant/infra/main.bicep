...
output mailMonitorStorageAccountUrl string = project.outputs.mailMonitorStorageAccountUrl

output mailMonitorStorageAccountId string = project.outputs.mailMonitorStorageAccountId

output mailMonitorStorageContainer string = project.outputs.mailMonitorStorageContainerName
