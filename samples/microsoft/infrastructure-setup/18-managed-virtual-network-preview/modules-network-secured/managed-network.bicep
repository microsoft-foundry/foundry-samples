...
resource managedNetworkSettings 'Microsoft.CognitiveServices/accounts/managedNetworkSettings@2025-04-01-preview' = {
  parent: aiAccount
  name: 'default'
  properties: {
...
#disable-next-line BCP081
resource storageOutboundRule 'Microsoft.CognitiveServices/accounts/managedNetworkSettings/outboundRules@2025-04-01-preview' = {
  parent: managedNetworkSettings
...
#disable-next-line BCP081
resource aiSearchOutboundRule 'Microsoft.CognitiveServices/accounts/managedNetworkSettings/outboundRules@2025-04-01-preview' = {
  parent: managedNetworkSettings
...
#disable-next-line BCP081
resource cosmosDBOutboundRule 'Microsoft.CognitiveServices/accounts/managedNetworkSettings/outboundRules@2025-04-01-preview' = {
  parent: managedNetworkSettings
...
output managedNetworkSettingsName string = managedNetworkSettings.name
