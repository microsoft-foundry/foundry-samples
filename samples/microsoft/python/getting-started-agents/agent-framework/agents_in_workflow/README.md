...
The hosted agent workflow can be seamlessly deployed to Azure AI Foundry using the Azure Developer CLI [ai agent](https://aka.ms/azdaiagent/docs) extension.
