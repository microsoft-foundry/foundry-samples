...
class VideoTranslationPlugin:
    ...
    def translate_video(self, 
                       ...
                       subtitle_max_char_count: Annotated[Optional[Union[int, str]], "Maximum characters per subtitle segment (optional)"] = None,
        ...
        try:
            ...
            logger.debug(f"Calling translation API with voice_kind={voice_kind}, speaker_count={speaker_count_int}")
        ...
        try:
            ...
            async with AsyncDefaultAzureCredential() as credential:
                ...
                try:
                    ...
                    logger.debug(f"File upload complete")
                    ...
                    try:
                        ...
                        logger.debug(f"SAS URL generated (valid for 24 hours)")
